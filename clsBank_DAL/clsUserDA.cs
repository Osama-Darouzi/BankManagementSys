...
namespace BankDAL
{
    public static class clsUserDA
    {
        ...
        public static bool GetByID(int UserID, ref int PersonID, ref string FirstName, ref string LastName,
            ref string Email,ref string Address, ref string ImagePath, ref string Username, ref string Password, ref int Permissions)
        {
            bool IsFound = false;
            ...
            try
            {
                ...
                {
                    IsFound = true;
                    _GetValues(reader, ref PersonID, ref FirstName, ref LastName, ref Email,ref Address, ref ImagePath, ref Username, ref Password, ref Permissions);
                }
        ...
        public static bool GetByUsername(string Username, ref int UserID, ref int PersonID, ref string FirstName, ref string LastName,
            ref string Email, ref string Address, ref string ImagePath, ref string Password, ref int Permissions)
        {
            bool IsFound = false;
